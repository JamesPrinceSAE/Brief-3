...
/// </summary>
public static class CrateGameEvents 
{
    public delegate void TransformDelegate(Transform CrateDestroyed);
    ...
    public delegate void GameObjectListDelegate(List<GameObject> allCratesSpawnedIn);
    ...
    /// </summary>
    public static IntDelegate SpawnCratesEvent;

    /// <summary>
    /// Called after the tanks have been spawned in
    /// </summary>
    public static GameObjectListDelegate OnCratesSpawnedEvent;
